...
export default function SEEPRODUCTDETAIL(props) {
  ...
  function onChangeSelectPorcProduct(event, index) {
    ...
    let valPor = Number(event.target.value);
  ...
  function handleFormSubmission() {
    ...
    Swal.fire({
      title: `Se creara un cliente con nombre : ${name} y clave: ${clave}, Quieres continuar?`,
      showDenyButton: true,
      ...
      if (result.isConfirmed) {
        regisProduct(productRegisForm).then((res) => {
          ...
          if (res.status) {
            Swal.fire({
              icon: "success",
              title: `Se creo producto: ${res.data.product.clave}`,
                            ...
                            >
                              ...
                              {MP.length > 1 ? (
                                <Button
                                  ...
                                  type="danger"
                                  id={index}
                                  onClick={(e) => handleDeleteMP(e, index)}
                                >
                                  <DeleteOutlined
                                    key={`c${index}`}
                                    style={{
                          ...
                          >
                            ...
                            >
                              <Select
                                ...
                                onChange={(e, i) => {
                                  onChangeSelectProduct(e, indexprod, i);
                                }}
                                name="productMP"
                              >
                                {!productList ? (
                              ...
                              <Input
                                ...
                                name="Porcentaje"
                                onChange={(e) =>
                                  onChangeSelectPorcProduct(e, indexprod)
                                }
                              ...
                              {productMP.length > 1 ? (
                                <Button
                                  ...
                                  id={indexprod}
                                  onClick={(e) =>
                                    handleDeleteProduct(e, indexprod)
                                  }
                                >
                                  <DeleteOutlined
                                    key={`cx${indexprod}`}
